...
type RegisterRequest struct {
	...
	Passwoed string `protobuf:"bytes,2,opt,name=passwoed,proto3" json:"passwoed,omitempty"`
}
...
func (x *RegisterRequest) GetPasswoed() string {
	if x != nil {
		return x.Passwoed
	}
	return ""
...
var file_sso_sso_proto_rawDesc = []byte{
	...
	0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x65, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x65, 0x64, 0x22, 0x2b, 0x0a, 0x10, 0x52, 0x65,
	...
	0x32, 0xaa, 0x01, 0x0a, 0x04, 0x41, 0x75, 0x74, 0x68, 0x12, 0x38, 0x0a, 0x07, 0x52, 0x65, 0x67,
	0x69, 0x74, 0x65, 0x72, 0x12, 0x15, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x52, 0x65, 0x67, 0x69,
	...
	0x18, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x70, 0x6c, 0x61, 0x63, 0x65, 0x2e, 0x73, 0x73, 0x6f,
...
var file_sso_sso_proto_depIdxs = []int32{
	0, // 0: auth.Auth.Regiter:input_type -> auth.RegisterRequest
	2, // 1: auth.Auth.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Auth.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Auth.Regiter:output_type -> auth.RegisterResponse
